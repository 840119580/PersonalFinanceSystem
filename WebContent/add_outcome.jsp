...
String loginremark=request.getParameter("remarks");
...
String sql1="Insert into outcome (id,dateyear,datemonth,dateday,datehour,dateminute,counts,remark) values(?,?,?,?,?,?,?,?)";
...
<div id="out_ok" class="login">
	<div class="login-top">
		<h1>个人支出添加成功</h1>
	</div>
</div>
<%--<center><h3>个人支出添加成功</h3></center>--%>
</body>
</html>